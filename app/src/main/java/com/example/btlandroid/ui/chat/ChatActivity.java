...
public class ChatActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Ánh xạ View
        ImageButton btnBack = findViewById(com.example.btlandroid.R.id.btnBack);
        btnBack.setOnClickListener(v -> {
            finish();
        });

        TextView txtNameTop = findViewById(com.example.btlandroid.R.id.txtNameTop);
        TextView txtNameCenter = findViewById(com.example.btlandroid.R.id.txtNameCenter);
        txtHint = findViewById(com.example.btlandroid.R.id.txtOneTimeWarning);
        btnAccept = findViewById(com.example.btlandroid.R.id.btnAccept);
        btnReject = findViewById(com.example.btlandroid.R.id.btnReject);
        requestApprovalWrapper = findViewById(com.example.btlandroid.R.id.requestApprovalWrapper);
        ...
        recyclerView = findViewById(com.example.btlandroid.R.id.recyclerChat);
        edtMessage = findViewById(com.example.btlandroid.R.id.edtMessage);
